...
func (x *PaymentStatusResponse) GetFound() bool {
	if x != nil {
		return x.Found
	}
	return false
...
const file_payment_proto_rawDesc = "" +
	...
	"\x14PaymentStatusRequest\x12\x19\n" +
	"\border_id\x18\x01 \x01(\tR\aorderId\"E\n" +
	"\x15PaymentStatusResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x14\n" +
	"\x05found\x18\x02 \x01(\bR\x05found2\xa8\x01\n" +
	"\x0ePaymentService\x12C\n" +
	"\x0eProcessPayment\x12\x17.payment.PaymentRequest\x1a\x18.payment.PaymentResponse\x12Q\n" +
	"\x10GetPaymentStatus\x12\x1d.payment.PaymentStatusRequest\x1a\x1e.payment.PaymentStatusResponseB5Z3github.com/taubakabylnurlybek/ap2-generated/paymentb\x06proto3"
...
var file_payment_proto_depIdxs = []int32{
	...
	2, // 2: payment.PaymentService.GetPaymentStatus:input_type -> payment.PaymentStatusRequest
